...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new House("Tyler", "Green Street Northampton, MA 01063", 4, true, false));
        myMap.addBuilding(new Cafe("Campus Center Cafe", "100 Elm Street Northampton, MA 01063", 1));
        myMap.addBuilding(new Library("Hillyer Art Library", "20 Elm Street Northampton, MA 01063", 2, true));
        ...
        myMap.addBuilding(new House("Hubbard House", "3 Green Street Northampton, MA 01063", 4, false, false));
