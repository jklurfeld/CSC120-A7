...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new House("Lamont House", "17 Prospect Street Northampton, MA 01063", 4, true));
        ...
        myMap.addBuilding(new House("Tyler", "Green Street Northampton, MA 01063", 4, true));
